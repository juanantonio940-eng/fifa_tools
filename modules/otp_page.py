...
PÁGINA FIFA OTP
===============
Consulta de códigos OTP de FIFA desde correos de iCloud
"""
...
# URL del webhook
WEBHOOK_URL = "https://fastapi-fastapi-webhook.6nzk5m.easypanel.host/webhook"

# === TRADUCCIONES ===
TRANSLATIONS = {
    "es": {
        "title": "Consultar OTP",
        "subtitle": "Obtén el código OTP de FIFA desde iCloud",
        "email_label": "Email de iCloud",
        "email_placeholder": "ejemplo@icloud.com",
        "email_help": "Ingresa el email de iCloud asociado a la cuenta FIFA",
        ...
        "no_messages": "No se encontraron mensajes de FIFA no leídos",
        "possible_reasons": "Posibles razones",
        "reason_1": "No hay correos de FIFA del día de hoy",
        ...
        "step_1": "Ingresa el email de iCloud asociado a la cuenta FIFA",
        "step_2": "El sistema consulta los correos no leídos de FIFA",
    ...
    "en": {
        "title": "Query OTP",
        "subtitle": "Get FIFA OTP code from iCloud",
        "email_label": "iCloud Email",
        "email_placeholder": "example@icloud.com",
        "email_help": "Enter the iCloud email associated with the FIFA account",
        ...
        "no_messages": "No unread FIFA messages found",
        "possible_reasons": "Possible reasons",
        "reason_1": "No FIFA emails from today",
        ...
        "step_1": "Enter the iCloud email associated with the FIFA account",
        "step_2": "The system queries unread FIFA emails",
        "step_3": "Automatically extracts the OTP code",
        "step_4": "Copy the code and use it before it expires",
        "btn_clear": "Clear",
    },
    "hi": {
        "title": "OTP प्राप्त करें",
        "subtitle": "iCloud से FIFA OTP कोड प्राप्त करें",
        "email_label": "iCloud ईमेल",
        "email_placeholder": "example@icloud.com",
        "email_help": "FIFA खाते से जुड़ा iCloud ईमेल दर्ज करें",
        ...
        "no_messages": "कोई अपठित FIFA संदेश नहीं मिला",
        "possible_reasons": "संभावित कारण",
        "reason_1": "आज के FIFA ईमेल नहीं हैं",
        ...
        "step_1": "FIFA खाते से जुड़ा iCloud ईमेल दर्ज करें",
        "step_2": "सिस्टम अपठित FIFA ईमेल खोजता है",
...
def render():
    ...
    def clear_email():
        st.session_state.email_field_otp = ""
